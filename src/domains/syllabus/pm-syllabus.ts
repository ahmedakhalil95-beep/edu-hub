        ...
        topics: [
          {
            ...
            learningOutcomes: [
              ...
              },
              {
                ...
                workedExample:
                  "If revenue is 200,000 and cost of sales is 120,000, gross profit is 80,000. Gross profit margin is 80,000 / 200,000 x 100 = 40%. This means 40% of sales revenue remains after direct costs.",
                commonMistakes: [
...
export function getAllChapters(): PMSyllabusChapter[] {
  return pmSyllabus.flatMap((area) => area.chapters);
}

export function getAllLearningOutcomes(): PMSyllabusLearningOutcome[] {
  return getAllChapters().flatMap((chapter) =>
    chapter.topics.flatMap((topic) => topic.learningOutcomes),
  );
}
